...
public class ZoomInZoomOut : MonoBehaviour
{
    ...
    public float perspectiveZoomSpeed = 0.5f;        // ÁÜÀÎ/¾Æ¿ô ¼Óµµ
    public float orthoZoomSpeed = 0.5f;              // Á¤»ç¿µ ¸ðµå¿¡¼­ ÁÜÀÎ/¾Æ¿ô ¼Óµµ

    public float minZoomDistance = 10.0f;             // ÃÖ¼Ò ÁÜ °Å¸®
    public float maxZoomDistance = 60.0f;            // ÃÖ´ë ÁÜ °Å¸®
