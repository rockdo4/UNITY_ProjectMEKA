...
//        var tile = tileMap.tiles[TileMap.selectedTileType]; // 3d 오브젝트로 변경
//        if (tile == null)
//        {
//            return;
//        }

//        // ***selectedTileType에 맞는 타일프리팹 생성
...
//        //brush.brushSize = new Vector2(tile.textureRect.width, tile.textureRect.height); // 기즈모 용도
//        //brush.brushSize /= tileMap.pixelToUnits; // 기즈모 용도

//        //brush.UpdateBrush(tile);
//    }
...
//        {
//            if (array[0] is Sprite)
//            {
//                tileMap.sprites[0] = array[0] as Sprite;
//            }
//        }
...
//        var w = sampleSprite.textureRect.width; // 3d 타일의 x 길이
//        var h = sampleSprite.textureRect.height; // 3d 타일의 z 길이
...
//        if (brush != null)
//        {
//            var tile = tileMap.tiles[TileMap.selectedTileType];
//            if (brush.spriteRenderer.sprite != tile)
//            {
//                brush.UpdateBrush(tile);
//            }
